//
//  PreviewSendContractViewController.swift
//  Gopher
//
...
class PreviewSendContractViewController: BaseViewController, TTTAttributedLabelDelegate {
   ...
   //MARK:- IBAction Button
    ...
    func MakeAPICall()
    {
        ...
        let params = ["buyer_id":buyerId,"seller_id":UserModel.getUserData().userId,"gig_post_id":gigPostId,"datetime":Commons.changeDateFormat (dateFrom:currentDateTime)] as [String : Any]
        print(params)
