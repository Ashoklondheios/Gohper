...
class NewPostViewController: UIViewController, UIPickerViewDataSource,UIPickerViewDelegate, UIPopoverPresentationControllerDelegate, UITextFieldDelegate,MyProtocol{
    ...
    func doneClick(sender:UIBarButtonItem) {
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "yyyy-MM-dd HH:mm:ss"
        deadlineDate =  dateFormatter.string(from: datePickerView.date as Date)
...
//        self.view.endEditing(true)
    ...
    func addDoneButtonOnKeyboard()
    {
        ...
        let done: UIBarButtonItem = UIBarButtonItem(title: "Done", style: UIBarButtonItemStyle.done, target: self, action: #selector(NewPostViewController.doneButtonAction))
...
extension NewPostViewController {
    ...
    func setUpSearchController() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NewPostViewController.keyboardWillShowFor(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
        ...
        clearButton.addTarget(self, action: #selector(NewPostViewController.clearButtonAction), for: UIControlEvents.touchUpInside)
...
//MARK:- Add Search View
    ...
    func secondAnimatedView(placeHolder: String) {
        ...
        let recongnizer = UITapGestureRecognizer(target: self, action: #selector(NewPostViewController.hideSearchView))
...
//MARK:- Custom Location Address
extension NewPostViewController: UISearchControllerDelegate, UISearchResultsUpdating,UISearchBarDelegate,UITableViewDelegate, UITableViewDataSource,UIGestureRecognizerDelegate {
